...
.. _file_src_performance_indicators_diss.hpp:
...
Definition (``src/performance_indicators_diss.hpp``)
----------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_src_performance_indicators_diss.hpp.rst
...
- ``graph_dijkstra.hpp`` (:ref:`file_src_graph_dijkstra.hpp`)

- ``graspi_predicates.hpp`` (:ref:`file_src_graspi_predicates.hpp`)

- ``graspi_types.hpp`` (:ref:`file_src_graspi_types.hpp`)
